...
HD_PWD='D:/Vivado/_DATN/FFT/FFT_final/FFT_final.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DDS_FFT_ethernet_final_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DDS_FFT_ethernet_final_wrapper.tcl -notrace
