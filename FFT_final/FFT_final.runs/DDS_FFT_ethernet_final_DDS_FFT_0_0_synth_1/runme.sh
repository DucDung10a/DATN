...
HD_PWD='D:/Vivado/_DATN/FFT/FFT_final/FFT_final.runs/DDS_FFT_ethernet_final_DDS_FFT_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DDS_FFT_ethernet_final_DDS_FFT_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DDS_FFT_ethernet_final_DDS_FFT_0_0.tcl
