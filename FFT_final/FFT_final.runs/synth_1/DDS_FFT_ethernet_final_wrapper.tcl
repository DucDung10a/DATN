...
namespace eval ::optrace {
  variable script "D:/Vivado/_DATN/FFT/FFT_final/FFT_final.runs/synth_1/DDS_FFT_ethernet_final_wrapper.tcl"
...
read_checkpoint -auto_incremental -incremental D:/Vivado/_DATN/FFT/FFT_final/FFT_final.srcs/utils_1/imports/synth_1/DDS_FFT_ethernet_final_wrapper.dcp
close [open __synthesis_is_running__ w]

OPTRACE "synth_design" START { }
synth_design -top DDS_FFT_ethernet_final_wrapper -part xc7z020clg400-2
...
write_checkpoint -force -noxdef DDS_FFT_ethernet_final_wrapper.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file DDS_FFT_ethernet_final_wrapper_utilization_synth.rpt -pb DDS_FFT_ethernet_final_wrapper_utilization_synth.pb"
