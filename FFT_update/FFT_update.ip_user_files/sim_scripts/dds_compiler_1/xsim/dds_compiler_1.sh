...
#
# Generated by Vivado on Thu Nov 28 15:01:43 +0700 2024
...
# Script info
echo -e "dds_compiler_1.sh - Script generated by export_simulation (Vivado v2022.2 (64-bit)-id)\n"
...
simulate()
{
  xsim  dds_compiler_1 -key {Behavioral:sim_1:Functional:dds_compiler_1} -tclbatch cmd.tcl -protoinst "protoinst_files/FFT_update.protoinst" -log simulate.log
}
