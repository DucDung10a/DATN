...
HD_PWD='D:/Vivado/_DATN/FFT/FFT_update/FFT_update.runs/FFT_update_ila_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FFT_update_ila_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FFT_update_ila_0_0.tcl
