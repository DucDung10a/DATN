...
HD_PWD='D:/Vivado/_DATN/FFT/FFT_update/FFT_update.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FFT_update_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FFT_update_wrapper.tcl
