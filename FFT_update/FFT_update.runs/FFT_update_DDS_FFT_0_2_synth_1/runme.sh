...
HD_PWD='D:/Vivado/_DATN/FFT/FFT_update/FFT_update.runs/FFT_update_DDS_FFT_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FFT_update_DDS_FFT_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FFT_update_DDS_FFT_0_2.tcl
