...
HD_PWD='D:/Vivado/_DATN/FFT/FFT_update/FFT_update.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FFT_update_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FFT_update_wrapper.tcl -notrace
